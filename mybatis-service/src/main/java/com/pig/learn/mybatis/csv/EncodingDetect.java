...
/**
 *本文来自
 * http://read.pudn.com/downloads171/sourcecode/java/793442/EncodingDetect.java__.htm
 *
 */
public class EncodingDetect {
    ...
    private static String[] nicename = new String[TOTAL_ENCODINGS];
    private static String[] codings = new String[TOTAL_ENCODINGS];
    ...
    public int detectEncoding(URL testurl) {
        ...
        try {
            ...
            if (chinesestream != null) {
                try {
                    chinesestream.close();
                } catch (IOException e) {
                    System.err.println("Error close " + e.toString());
                }
            }
        }
        return guess;
